/**
	...
	var parts = new multipart.Multipart(body, req.headers['content-type']);
...
class Multipart {
	constructor(multipartBodyBuffer, contentTypeHeader) {
		//  read the boundary from the content-type header sent by the http client
		//  this value may be similar to:
		//  'multipart/form-data; boundary=xYzZY',
		function getBoundary() {
			var items = contentTypeHeader.split(';');
			var boundary = "";
		...
		this.multipartBodyBuffer = multipartBodyBuffer;
